...
use MakinaCorpus\APubSub\Error\SubscriptionAlreadyExistsException;
...
abstract class AbstractSubscriberTest extends AbstractBackendBasedTest
{
    ...
    public function testGetSubscriber()
    {
        ...
        $this->assertInstanceOf('\MakinaCorpus\APubSub\SubscriberInterface', $subscriber);
    ...
    public function testMassUpdate()
    {
        ...
        $subscriber->subscribe($chan1->getId());
