...
class MongoContext implements ContextInterface
{
    /**
     * @var \MongoDB
     */
    ...
    /**
     * @var \APubSub\Backend\Mongo\InternalCache
     */
    public $cache;
    ...
    /**
     * @var \APubSub\Backend\Mongo\MongoPubSub
     */
    public $backend;
     ...
     * Default constructor
     *
     * @param \MongoDB $dbConnection     Database connection
     * @param MongoPubSub $backend       Backend
     * @param array|Traversable $options Options, if any
     */
    public function __construct(\MongoDB $dbConnection,
        MongoPubSub $backend, $options = null)
    {
        ...
        $this->chanCollection  = $this->dbConnection->apbChan;
        $this->queueCollection = $this->dbConnection->apbQueue;
        $this->subCollection   = $this->dbConnection->apbSub;
    }
